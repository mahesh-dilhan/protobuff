...
type service struct {
	...
	m map[int64]protogrpc.User
}

// NewService instantiates a new Service.
func NewService( /* a database connection would be injected here */ ) protogrpc.Service {
	return &service{
		m: map[int64]protogrpc.User{
			1: {ID: 1, Name: "Alice"},
			2: {ID: 2, Name: "Bob"},
...
func (s *service) GetUser(id int64) (result protogrpc.User, err error) {
...
func (s *service) GetUsers(ids []int64) (result map[int64]protogrpc.User, err error) {
